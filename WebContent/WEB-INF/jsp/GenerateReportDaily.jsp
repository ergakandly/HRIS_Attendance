...
final String REPORT_NAME = "AttendanceDaily.rpt";
final String EXPORT_FILE = "Exported_Attendance_Daily_Dept.pdf";
%>
...
try {
	...
	int i=0;
	String p_date = request.getAttribute("date").toString();
